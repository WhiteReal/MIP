...
class Metapath2VecTrainer:
    def __init__(self, args):
        self.data = DataReader(args.inputFilePath, args.min_count, args.care_type)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--inputFilePath',
                        default='/Users/white/PycharmProjects/deeplearning/Aminer_data/output/meta_path.txt',
                        type=str, help="inputFilePath")
    parser.add_argument('--output_file',
                        default='/Users/white/PycharmProjects/deeplearning/Aminer_data/output/output_embedding_all.txt',
